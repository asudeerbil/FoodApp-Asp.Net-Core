    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                MailboxAddress mailboxAdressFrom = new MailboxAddress("Eticaret Uygulaması", "asudeerbill@gmail.com");
                ...
                client.Authenticate("asudeerbill@gmail.com", "ycfc iukm xafj wafz");
